...
export default function Home() {
  ...
  <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
    ...
    <Link href="/chatbot" className="bg-red-500 text-white p-6 rounded-lg shadow-md hover:bg-red-600 transition">
      <h2 className="text-2xl font-semibold mb-2">Chatbot</h2>
      <p>A personalised chatbot that will answer your queries about anomalous conditions</p>
    </Link>
  </div>
</div>
      <div>
